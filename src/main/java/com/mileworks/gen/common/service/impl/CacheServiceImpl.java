...
public class CacheServiceImpl implements CacheService {
    ...
    public List<Role> getRoles(String username) throws Exception {
        String roleListString = this.redisService.get(MKConstant.USER_ROLE_CACHE_PREFIX + username);
    ...
    public List<Menu> getPermissions(String username) throws Exception {
        String permissionListString = this.redisService.get(MKConstant.USER_PERMISSION_CACHE_PREFIX + username);
    ...
    public void saveUser(User user) throws Exception {
        ...
        redisService.set(MKConstant.USER_CACHE_PREFIX + username, mapper.writeValueAsString(user));
    }
    ...
    public void saveRoles(String username) throws Exception {
        ...
        if (!roleList.isEmpty()) {
            ...
            redisService.set(MKConstant.USER_ROLE_CACHE_PREFIX + username, mapper.writeValueAsString(roleList));
        }
    ...
    public void savePermissions(String username) throws Exception {
        ...
        if (!permissionList.isEmpty()) {
            ...
            redisService.set(MKConstant.USER_PERMISSION_CACHE_PREFIX + username, mapper.writeValueAsString(permissionList));
        }
    }
    ...
    public void saveUserConfigs(String userId) throws Exception {
        ...
        if (userConfig != null) {
            ...
            redisService.set(MKConstant.USER_CONFIG_CACHE_PREFIX + userId, mapper.writeValueAsString(userConfig));
        }
    }
    ...
    public void deleteUser(String username) throws Exception {
        ...
        redisService.del(MKConstant.USER_CACHE_PREFIX + username);
    }

    @Override
    public void deleteRoles(String username) throws Exception {
        username = username.toLowerCase();
        redisService.del(MKConstant.USER_ROLE_CACHE_PREFIX + username);
    }

    @Override
    public void deletePermissions(String username) throws Exception {
        username = username.toLowerCase();
        redisService.del(MKConstant.USER_PERMISSION_CACHE_PREFIX + username);
    }

    @Override
    public void deleteUserConfigs(String userId) throws Exception {
        redisService.del(MKConstant.USER_CONFIG_CACHE_PREFIX + userId);
    }
}
